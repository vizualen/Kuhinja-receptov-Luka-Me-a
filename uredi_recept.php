...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES["slika"]) && $_FILES["slika"]["name"] != "") {
        ...
        if (mysqli_num_rows($preveri) > 0) {
            mysqli_query($povezava, "UPDATE slike SET ime = '$ime', url = '$potSlike' WHERE recepti_id = $id");
        } else {
            mysqli_query($povezava, "INSERT INTO slike (ime, url, recepti_id) VALUES ('$ime', '$potSlike', $id)");
        }
    }
